        ...
        function closeSidebar() {
            ...
            document.getElementById('banking-menu').classList.remove('active');
            document.getElementById('overlay').classList.remove('active');
        }

        function verifyAccount() {
            showAlert('Please complete the account verification process.', 'info');
        }
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!sidebar.contains(e.target) && !bankingMenu.contains(e.target) && !hamburger.contains(e.target)) {
                closeSidebar();
            }
        });
